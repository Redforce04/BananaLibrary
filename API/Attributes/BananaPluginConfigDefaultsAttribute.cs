// -----------------------------------------------------------------------
// <copyright file="BananaPluginConfigDefaultsAttribute.cs" company="Redforce04">
...
public sealed class BananaPluginConfigDefaultsAttribute : Attribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BananaPluginConfigDefaultsAttribute"/> class.
    /// </summary>
    ...
    public BananaPluginConfigDefaultsAttribute(bool isEnabled = true, bool debug = false, string currentBananaServerId = "", string loggerPrefix = "BP")
    {
